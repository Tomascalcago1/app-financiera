    ...
    return (
      <div className="container animate-fade-in" style={{ padding: '2rem 0', maxWidth: '800px' }}>
        ...
        <header style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <h1 style={{ marginBottom: '0.75rem' }}>Terms of Use</h1>
        ...
        <section className="card" style={{ marginBottom: '2rem' }}>
          ...
          <p>
            Welcome to <strong>Valia</strong>. By accessing or using our website, you agree to comply with and be bound by 
            these Terms of Use. If you do not agree with any of these terms, please do not use our tools.
          </p>
        </section>
        ...
        <section className="card" style={{ 
          ...
          <p style={{ marginBottom: '1rem' }}>
            All information and results generated by Valia's calculators and simulators are provided for 
            <strong> strictly educational and informational purposes</strong>.
          </p>
          <p style={{ marginBottom: '1rem', fontWeight: 500 }}>
            Valia does not provide financial, investment, legal, accounting, or tax advice.
          </p>
          <p style={{ marginBottom: '1rem' }}>
            Calculations performed are simulations based on assumptions and historical data. The past performance of 
            financial markets (stocks, bonds, inflation) does not guarantee or predict future returns.
          </p>
          <p>
            We strongly recommend consulting with a certified financial advisor or other qualified professionals 
            before making investment decisions or executing financial transactions based on the information provided 
            by this tool.
          </p>
        </section>
        ...
        {/* Permitted Use */}
        <section className="card" style={{ marginBottom: '2rem' }}>
          <h2 style={{ fontSize: '1.125rem', marginBottom: '1rem' }}>2. License and Permitted Use</h2>
          <p style={{ marginBottom: '1rem' }}>
            We grant you a limited, non-exclusive, non-transferable, and revocable license to access and use 
            Valia's tools for your personal, non-commercial use.
          </p>
          <p style={{ marginBottom: '0.5rem' }}>You agree not to use the site to:</p>
          <ul style={{ paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', color: 'var(--text-secondary)' }}>
            <li>Extract info or data from the website using scraping, bots, or other automated mechanisms.</li>
            <li>Attempt to damage, disable, or overload the servers or network infrastructure.</li>
            <li>Use the calculators for commercial purposes without prior written consent from Valia.</li>
            <li>Perform illegal activities that violate the laws of your jurisdiction.</li>
          </ul>
        </section>

        {/* Intellectual Property */}
        <section className="card" style={{ marginBottom: '2rem' }}>
          <h2 style={{ fontSize: '1.125rem', marginBottom: '1rem' }}>3. Intellectual Property</h2>
          <p style={{ marginBottom: '1rem' }}>
            The source code, design, structure, logos, texts, and graphics of the website are the exclusive property of 
            Valia or their respective creators and are protected by intellectual property and copyright laws.
          </p>
          <p>
            References to external methodologies (such as the Trinity Study or ficalc.app) are made under the principle of 
            recognition of the original author and fair use.
          </p>
        </section>
        ...
        <section className="card" style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ marginBottom: '1rem' }}>
            We do not guarantee that the calculators will be error-free, that historical information will be 100% accurate 
            at all times, or that the service will be uninterrupted.
          </p>
          <p>
            To the maximum extent permitted by applicable law, Valia shall not be liable for any direct, indirect, 
            incidental, or consequential damages (including, without limitation, loss of money, loss of profits, 
            or poor investments) arising from the use or inability to use the site or its contents.
          </p>
        </section>
        ...
        <section className="card" style={{ marginBottom: '2rem' }}>
          ...
          <p>
            We reserve the right to modify these Terms of Use at any time. Any changes will take effect immediately 
            upon publication on the website. Continued use of the site after such changes constitutes acceptance of the new terms.
          </p>
        </section>

        {/* Governing Law */}
        <section className="card" style={{ marginBottom: '2rem' }}>
          <h2 style={{ fontSize: '1.125rem', marginBottom: '1rem' }}>6. Governing Law and Jurisdiction</h2>
          <p>
            These terms shall be governed by and construed in accordance with the laws of the Argentine Republic. Any dispute 
            arising in connection with the use of this website shall be submitted to the exclusive jurisdiction of the 
            competent ordinary courts of the Autonomous City of Buenos Aires, Argentina.
          </p>
        </section>
        ...
        <section className="card" style={{ 
          ...
          <p>
            If you have any questions, claims, or doubts regarding these Terms of Use, please write to us at{' '}
